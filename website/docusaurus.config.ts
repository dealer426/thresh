...
const config: Config = {
  title: 'thresh',
  tagline: 'Cross-Platform Container Environment Manager with AI-Powered Blueprint Generation',
    ...
    [
      'classic',
      {
        docs: {
          ...
          editUrl:
            'https://github.com/dealer426/thresh/tree/main/website/',
        },
        blog: {
      ...
      links: [
        ...
        },
        {
          ...
          items: [
            {
              label: 'GitHub Issues',
              href: 'https://github.com/dealer426/thresh/issues',
            },
            {
              label: 'Discussions',
              href: 'https://github.com/dealer426/thresh/discussions',
            },
          ],
        },
        {
          ...
          items: [
            ...
            {
              label: 'Changelog',
              href: 'https://github.com/dealer426/thresh/blob/main/CHANGELOG.md',
            },
          ],
        },
      ],
