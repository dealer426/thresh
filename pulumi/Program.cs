...
class Program
{
    static Task<int> Main() => Deployment.RunAsync(() =>
    {
        ...
        // Asset ID 444973053 = thresh-agent-linux-x64.tar.gz in v1.1.6 release (proc.exec deadlock + quoting fix).
        var agentAssetUrl = Environment.GetEnvironmentVariable("THRESH_AGENT_ASSET_URL")
            ?? "https://api.github.com/repos/dealer426/thresh-agent/releases/assets/444973053";
